...
#define PERCEPTION_REGISTER_CLASS(clazz, name)                                                                         \
    namespace                                                                                                          \
    {                                                                                                                  \
    class ObjectFactory##name : public design_pattern::etc::apollo::ObjectFactory                                      \
    {                                                                                                                  \
      public:                                                                                                          \
    ...
    {                                                                                                                  \
        auto GlobalFactoryMap = design_pattern::etc::apollo::GlobalFactoryMap;                                         \
        design_pattern::etc::apollo::FactoryMap &map1 = design_pattern::etc::apollo::GlobalFactoryMap()[#clazz];       \
