...
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI int \textbf{ metacall\+\_\+argc} (void)
\item 
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em name} & Name of the function (if it is N\+U\+LL, function is not registered into host scope)\\
\hline
...
\hline
\mbox{\texttt{ in}}  & {\em context} & Opaque pointer to the context in which you want to register the function (if it is N\+U\+LL, it will be defined on the global scope of the loader)\\
\hline
\mbox{\texttt{ in}}  & {\em name} & Name of the function (if it is N\+U\+LL, function is not registered into host scope)\\
\hline
\mbox{\texttt{ in}}  & {\em invoke} & Pointer to function invoke interface (argc, argv, data)\\
...
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI int \textbf{ metacall\+\_\+register\+\_\+loaderv} (void $\ast$\textbf{ loader}, void $\ast$\textbf{ context}, const char $\ast$name, void $\ast$($\ast$invoke)(size\+\_\+t, void $\ast$[$\,$], void $\ast$), enum \textbf{ metacall\+\_\+value\+\_\+id} return\+\_\+type, size\+\_\+t size, enum \textbf{ metacall\+\_\+value\+\_\+id} types[$\,$])
\item 
...
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI void $\ast$ \textbf{ metacall\+\_\+throwable\+\_\+value} (void $\ast$th)
\item 
...
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI void $\ast$ \textbf{ metacall\+\_\+plugin\+\_\+extension} (void)
\item 
const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char $\ast$ \textbf{ metacall\+\_\+plugin\+\_\+path} (void)
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI int \textbf{ metacall\+\_\+destroy} (void)
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI const struct \textbf{ metacall\+\_\+version\+\_\+type} $\ast$ \textbf{ metacall\+\_\+version} (void)
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI uint32\+\_\+t \textbf{ metacall\+\_\+version\+\_\+hex\+\_\+make} (unsigned int major, unsigned int minor, unsigned int patch)
\item 
M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI uint32\+\_\+t \textbf{ metacall\+\_\+version\+\_\+hex} (void)
\item 
const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char $\ast$ \textbf{ metacall\+\_\+version\+\_\+str} (void)
\item 
const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char $\ast$ \textbf{ metacall\+\_\+version\+\_\+revision} (void)
\item 
const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char $\ast$ \textbf{ metacall\+\_\+version\+\_\+name} (void)
\item 
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI int metacall\+\_\+argc (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
\mbox{\label{metacall_8h_afc4e32dfcccfefd3fec11b80f7edd10a}} 
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI int metacall\+\_\+register\+\_\+loaderv (\begin{DoxyParamCaption}\item[{void $\ast$}]{loader,  }\item[{void $\ast$}]{context,  }\item[{const char $\ast$}]{name,  }\item[{void $\ast$($\ast$)(size\+\_\+t, void $\ast$[$\,$], void $\ast$)}]{invoke,  }\item[{enum \textbf{ metacall\+\_\+value\+\_\+id}}]{return\+\_\+type,  }\item[{size\+\_\+t}]{size,  }\item[{enum \textbf{ metacall\+\_\+value\+\_\+id}}]{types[$\,$] }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI void$\ast$ metacall\+\_\+throwable\+\_\+value (\begin{DoxyParamCaption}\item[{void $\ast$}]{th }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Pointer to the value inside of the throwable or N\+U\+LL in case of error 
\end{DoxyReturn}
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI void$\ast$ metacall\+\_\+plugin\+\_\+extension (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\mbox{\label{metacall_8h_afde4e06d58d1a95a9e2843da55b6e713}} 
...
{\footnotesize\ttfamily const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char$\ast$ metacall\+\_\+plugin\+\_\+path (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI const struct \textbf{ metacall\+\_\+version\+\_\+type}$\ast$ metacall\+\_\+version (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI uint32\+\_\+t metacall\+\_\+version\+\_\+hex\+\_\+make (\begin{DoxyParamCaption}\item[{unsigned int}]{major,  }\item[{unsigned int}]{minor,  }\item[{unsigned int}]{patch }\end{DoxyParamCaption})}



Provide the module version hexadecimal value with format 0x\+M\+M\+I\+I\+P\+P\+PP where M is @major, I is @minor and P is @patch. 
...
{\footnotesize\ttfamily M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI uint32\+\_\+t metacall\+\_\+version\+\_\+hex (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
Hexadecimal integer containing packed version 
\end{DoxyReturn}
\mbox{\label{metacall_8h_ad25c32674e425ef8549a07ca8cd5dec2}} 
...
{\footnotesize\ttfamily const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char$\ast$ metacall\+\_\+version\+\_\+str (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\mbox{\label{metacall_8h_a0d3ab044ed8f609bf4b507e7b6574534}} 
...
{\footnotesize\ttfamily const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char$\ast$ metacall\+\_\+version\+\_\+revision (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\mbox{\label{metacall_8h_abd5c8598b0833bf26424310850484650}} 
...
{\footnotesize\ttfamily const M\+E\+T\+A\+C\+A\+L\+L\+\_\+\+A\+PI char$\ast$ metacall\+\_\+version\+\_\+name (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
